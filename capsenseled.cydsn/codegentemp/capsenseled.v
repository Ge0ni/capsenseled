...
module BLE_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("61b25ac8-5b3c-45c9-92f2-5646f366bed2/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module CapSense_CSD_P4_v2_60_3 ;
	...
	cy_clock_v1_0
		#(.id("3df69336-4598-4639-89b5-6a912c35a7cb/74063576-f256-4f8f-8a82-9abdee876261"),
	...
	cy_psoc3_pins_v1_10
		#(.id("3df69336-4598-4639-89b5-6a912c35a7cb/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3df69336-4598-4639-89b5-6a912c35a7cb/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
	...
	cy_clock_v1_0
		#(.id("3df69336-4598-4639-89b5-6a912c35a7cb/9a635726-510c-483c-9c5c-3e233ee2906a"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(255),
		  .period("0"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("11a27133-f037-4ee1-bd38-dcbd88196c5b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("913f5ab4-2cba-4dd2-841b-7c809b4eb3bb"),
		  .source_clock_id(""),
		  .divisor(0),
