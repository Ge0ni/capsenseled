...
//    uint8 red_State = !red_Read(); /* Read the LED state and invert it since it */
...
/******************************************************
* Function to update the CapSense state in the GATT database
******************************************************/
void updateCapsense()
{
    if (CyBle_GetState() != CYBLE_STATE_CONNECTED)
...
void BleCallBack(uint32 event, void* eventParam)
{
    ...
    switch(event)
    {
        /*if there is a disconnect or the stack just turned on from a reset then */
        ...
        /* when a connection is made, update the LED and CapSense states in the */
